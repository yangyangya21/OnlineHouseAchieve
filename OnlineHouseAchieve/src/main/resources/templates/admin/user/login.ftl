			...
			<form id="adminLoginForm">
				...
				<div class="login-center clearfix">
					...
					<div class="login-center-input">
						<input type="text" name="username" class="required" id="username" value="" placeholder="请输入您的用户名" onfocus="this.placeholder=&#39;&#39;" onblur="this.placeholder=&#39;请输入您的用户名&#39;" tips="用户名不能为空">
				...
				<div class="login-center clearfix">
					...
					<div class="login-center-input">
						...
						<img id="cpacha-img" title="点击切换验证码" style="cursor:pointer;" src="/common/cpacha/generate_cpacha?vl=4&fs=21&w=98&h=33&method=admin_user_login" width="110px" height="30px" onclick="changeCpacha()">
					</div>
				</div>
			</form>
...
<script type="text/javascript" src="/common/cookie/cookie_token.js"></script>
<script type="text/javascript">
	...
	function changeCpacha(){
		$("#cpacha-img").attr("src",'/common/cpacha/generate_cpacha?vl=4&fs=21&w=98&h=33&method=admin_user_login&t=' + new Date().getTime());
	}
		document.querySelector(".login-button").onclick = function(){
				...
				success:function(data){
					if(data.code == 0){
						setTokenToCookie("admin_login_token", data.data, 7);
